...
Let's load our data:
```{r setup-success}
penguins_success <- readr::read_csv("../data/penguins.csv")
```
...
If this is going to be annoying to you, you might want to check out the `here` package.
